...
def register_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Referral code
            referral_code = form.cleaned_data.get(
                'referral_code', ''
            ).strip().upper()
            ...
            if referral_code:
                try:
                    ...
                    print(
                        f"[REGISTER] Referrer found: "
                        f"{referrer.username}"
                    )

                except User.DoesNotExist:
                    print("[REGISTER] Referrer not found")
            ...
            Notification.objects.create(
                ...
                message=(
                    f'Hi {user.username}, welcome to Earnnest! '
                    f'You have received a free Ksh 50 bonus. '
                    f'Pay Ksh 200 to activate your account '
                    f'and start earning. '
                    f'Invest, refer friends and play games '
                    f'to earn daily!'
                )
            )
            ...
            messages.success(
                ...
                f'Pay Ksh 200 to activate and start earning.'
            )

            return redirect('payments:activate')

        print("[REGISTER] Form invalid - re-rendering")
